...
export const useIngredientStore = create<IngredientState>((set) => ({
  ...
  loadIngredients: async () => {
    ...
    try {
      ...
      set({ error: "Fehler beim Laden der Zutaten", isLoading: false });
    }
  },
  addIngredient: async (formData: FormData) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Fehler beim Hinzufügen der Zutat", isLoading: false });
    }
  },
  removeIngredient: async (id: string) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Fehler beim Löschen der Zutat", isLoading: false });
    }
  }
}));
