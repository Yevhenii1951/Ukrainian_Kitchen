...
export const useRecipeStore = create<IRecipeState>((set) => ({
  ...
  loadRecipes: async () => {
    ...
    try {
      ...
      set({ error: "Fehler beim Laden der Rezepte", isLoading: false });
    }
  },
  addRecipe: async (formData: FormData) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Fehler beim Hinzufügen des Rezepts", isLoading: false });
      return { success: false, error: "Fehler beim Hinzufügen des Rezepts" };
    }
  },
  updateRecipe: async (id: string, formData: FormData) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Fehler beim Aktualisieren des Rezepts", isLoading: false });
  ...
  removeRecipe: async (id: string) => {
    ...
    try {
      ...
      console.error("error", error);
      set({ error: "Fehler beim Löschen des Rezepts", isLoading: false });
    }
  }
}));
